package com.notificationservice.host.controller.exceptionhandler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleInvalidRequestDataException(
            InvalidRequestDataException ex, WebRequest request) {
